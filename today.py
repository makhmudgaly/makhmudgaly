...
def add_archive():
    ...
    with open('cache/repository_archive.txt', 'r') as f:
        data = f.readlines()
    data = data[7:] # remove the comment block
...
if __name__ == '__main__':
    ...
    age_data, age_time = perf_counter(daily_readme, datetime.datetime(1996, 6, 1))
    ...
    if OWNER_ID == {'id': 'MDQ6VXNlcjE5Nzc0MTc2'}: # only calculate for user makhmudgaly
